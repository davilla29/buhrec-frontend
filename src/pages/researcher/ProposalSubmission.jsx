...
const ProposalSubmission = () => {
  ...
  const saveProgress = async (isProceedingToPayment = false) => {
    if (isPaid) return;

    try {
      setSaving(true);
      const loadingToast = toast.loading(
        isProceedingToPayment ? "Saving details before payment..." : "Saving draft..."
      );
      ...
      toast.success(
        isProceedingToPayment ? "Details saved!" : "Draft saved successfully",
        { id: loadingToast }
      );

      setShowModal(false);

      // Route based on the action the user took
