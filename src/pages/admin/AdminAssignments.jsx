...
const AssignmentsPage = () => {
  ...
  const { items, status } = useSelector((state) => state.assignment);
          ...
          items?.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <button
                  className={`${buttonColor} text-white px-8 py-2.5 rounded-full text-sm font-semibold transition-transform active:scale-95`}
                >
                  View Details
                </button>
              </div>
