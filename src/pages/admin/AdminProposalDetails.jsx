...
//   // 1. Check if the URL contains .pdf (even if it's .pdf.pdf)
//   const isPdf = documentContent?.url?.toLowerCase().includes(".pdf");

//   // 2. If it's a PDF, use the raw URL directly. If it's Word/Excel, use Google Viewer.
...
//   }`}
//         >
//           {assignment ? "Unassign Reviewer" : "Assign Reviewer"}
//         </button>
//       </header>
